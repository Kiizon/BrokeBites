...
def get_recipes_for_flyer(flyer_id):
    try:
        items = fetch_items(flyer_id)
        print(f"Fetched items for flyer {flyer_id}:", items)  # Debug log
        ...
        print(f"Item names for recipe generation: {item_names}")  # Debug log
        ...
        print(f"Error in get_recipes_for_flyer: {e}")  # Debug log
